...
[BASE] = LAYOUT_ergodox(  // layer 0 : default
        ...
        KC_LSFT,         KC_Z,         KC_X,           KC_C,     KC_V,     KC_B,   C_S(KC_SCLN),
        KC_GRV,          KC_TRNS,      KC_TRNS,        KC_TRNS,  KC_LGUI,
                                                       KC_TRNS,  KC_TRNS,
                                                                 KC_TRNS,
                                              KC_SPC,  KC_ENT,   KC_LSFT,
        // right hand
         KC_TRNS,       KC_6,          KC_7,         KC_8,       KC_9,      KC_0,               KC_BSPC,
         KC_TRNS,       KC_Y,          KC_U,         KC_I,       KC_O,      KC_P,               KC_BSLS,
                        KC_H,          KC_J,         KC_K,       KC_L,      LT(MDIA, KC_SCLN),  KC_ENT,
         C_S(KC_J),     KC_N,          KC_M,         KC_COMM,    KC_DOT,    CTL_T(KC_SLSH),     KC_RSFT,
